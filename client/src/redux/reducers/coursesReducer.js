import { ADD_QUESTION, PUBLISH_LECTURE_IN_SECTION, ADD_LECTURES_IN_SECTION, SET_COURSES, CREATE_COURSE, DELETE_COURSE, UPDATE_COURSE, JOIN_COURSE, ADD_LECTURES, ADD_QUESTIONS, ADD_SECTIONS, ADD_SECTION, ADD_ENROLLMENTS } from '../actions'
