	...
	return (
		<div className='navbarMain' expand='lg'>
			<div className='navbarLeftContainer'>
				...
				<span>
					<NavLink className='navbarItem' id='classroomLink' to='/home'>
						<img id='classroomIcon' src='classroomIcon.png' />
...
function LoggedOutRight() {
	return (
		<span className='navButtons rightButtons'>
			...
			<a href='/create' className='navSignup'>
				{" "}
				Get Started{" "}
			</a>
		</span>
		...
		<>
			{props.loggedIn === true ? (
				<div className='dropdownMenu'>
					...
					<div className='dropdownItem'>
						<NavLink onClick={logoutUser} className='dropdownLink' to='/login'>
							Logout
						</NavLink>
					</div>{" "}
					{/* TODO: attach logout functionality (i.e. API request trigger)*/}
				</div>
			) : (
				<div className='dropdownMenu'>
					<div className='dropdownItem'>
						<NavLink className='dropdownLink' to='/create'>
							Sign Up
						</NavLink>
					</div>
					<div className='dropdownItem'>
						<NavLink className='dropdownLink' to='/login'>
							Login
						</NavLink>
					</div>
				</div>
